...
#     for title in job_titles:
#         for loc in locations:
#             search_query = f"{title} at B2B SaaS companies in {loc} site:linkedin.com/in/"
#             print(f"🔍 Searching: {search_query}")
#             results = tavily_search(search_query)

#             leads = [
#                 {
#                     "name_guess": res["title"],
#                     "linkedin_url": res["url"],
#                     "snippet": res["content"],
#                     "title": title,
#                     "location": loc
#                 }
#                 for res in results.get("results", []) if "linkedin.com/in/" in res["url"]
#             ]
